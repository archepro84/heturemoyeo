const CLEAR_DATA = {
    ...
    Password: "!@#4qwer",
    Nickname: "KKK",
    ProfileImg: "https://t1.daumcdn.net/cfile/tistory/99AF903359A15D8A1E",
    StatusMessage: "Hello My Name Is qWsWa2Qes",
    LikeItem: ["Game", "Board", "Hello"],
    Authorization:
    ...
    PostContent: "hello",
    PostMaxmember: 10,
    PostStartDate: "2021-08-10",
    PostEndDate: "2021-08-10",
    PostPlace: "house",
    PostLat: 50,
    PostLng: 50,
    PostBring: "money, beer",
    PostTag: ["볼링", "축구", "농구"],
